...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,tailwind,nodejs,js,ts,react,nextjs,express,npm,pnpm,bun,yarn,py,pycharm,django,flask,fastapi,git,github,gitlab,prisma,graphql,kafka,rabbitmq,vite,webpack,wordpress,cypress,jest,postman&theme=light)](https://skillicons.dev)

## Mobile Development

[![My Skills](https://skillicons.dev/icons?i=flutter,swift,kotlin,androidstudio,apple,gradle&theme=light)](https://skillicons.dev)

## Databases

[![My Skills](https://skillicons.dev/icons?i=appwrite,dynamodb,elasticsearch,firebase,supabase,mongodb,mysql,postgres,planetscale,redis,sqlite,sequelize&theme=light)](https://skillicons.dev)

## DevOps

[![My Skills](https://skillicons.dev/icons?i=aws,azure,gcp,ansible,terraform,ubuntu,bash,docker,git,github,githubactions,gitlab,jenkins,kubernetes,linux,neovim,cloudflare,nginx,powershell,grafana,prometheus,sentry&theme=light)](https://skillicons.dev)
